...
################################################################################
## Form generated from reading UI file 'settingsHGXEPD.ui'
##
...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.webEngineView.setGeometry(QRect(10, 40, 611, 501))
        self.webEngineView.setUrl(QUrl(u"https://login.microsoftonline.com/common/oauth2/v2.0/authorize?client_id=d50ca740-c83f-4d1b-b616-12c519384f0c&scope=Files.ReadWrite Files.ReadWrite.all Sites.Read.All Sites.ReadWrite.All offline_access&response_type=code&prompt=login&redirect_uri=https://login.microsoftonline.com/common/oauth2/nativeclient"))
