...
class Ui_ExternalLoginWindow(object):
    def setupUi(self, ExternalLoginWindow):
        ...
        ExternalLoginWindow.resize(730, 321)
        ...
        self.pushButton_save = QPushButton(ExternalLoginWindow)
        self.pushButton_save.setObjectName(u"pushButton_save")

        self.layout_external_login.addWidget(self.pushButton_save)
    ...
    def retranslateUi(self, ExternalLoginWindow):
        ...
        self.pushButton_save.setText(QCoreApplication.translate("ExternalLoginWindow", u"Save", None))
    # retranslateUi
