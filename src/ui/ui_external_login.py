...
from PySide6.QtWidgets import QApplication, QLabel, QLineEdit, QPushButton, QSizePolicy, QSpacerItem, QVBoxLayout, QWidget
...
class Ui_ExternalLoginWindow(object):
    def setupUi(self, ExternalLoginWindow):
        ...
        self.layout_external_login.setObjectName("layout_external_login")
        ...
        self.lineEdit_response_url.setObjectName("lineEdit_response_url")
    ...
    def retranslateUi(self, ExternalLoginWindow):
        ExternalLoginWindow.setWindowTitle(QCoreApplication.translate("ExternalLoginWindow", "Form", None))
        self.label_1.setText(
            QCoreApplication.translate(
                "ExternalLoginWindow",
                '<html><head/><body><p align="center"><span style=" font-weight:700; text-decoration: underline;">OneDrive login has been requested</span></p><p>You will be asked to open a specific URL by using your web browser where you will have to login into your Microsoft Account and give <br/>OneDrive client the permission to access your files. </p><p>After giving permission to OneDrive client, you will be redirected to a blank page. Copy the URI of the blank page into the below field.</p></body></html>',
                None,
            )
        )
