...
class Ui_profile_settings(object):
    def setupUi(self, profile_settings):
        ...
        self.checkBox_display_manager_integration = QCheckBox(self.groupBox_12)
        self.checkBox_display_manager_integration.setObjectName(u"checkBox_display_manager_integration")

        self.gridLayout_3.addWidget(self.checkBox_display_manager_integration, 1, 0, 1, 1)

        self.pushButton_logout = QPushButton(self.groupBox_12)
        self.pushButton_logout.setObjectName(u"pushButton_logout")

        self.gridLayout_3.addWidget(self.pushButton_logout, 3, 0, 1, 1)

        self.pushButton_login = QPushButton(self.groupBox_12)
        self.pushButton_login.setObjectName(u"pushButton_login")

        self.gridLayout_3.addWidget(self.pushButton_login, 2, 0, 1, 1)
...
#if QT_CONFIG(tooltip)
        self.checkBox_sync_business_shared_items.setToolTip(QCoreApplication.translate("profile_settings", u"<html><head/><body><p>Refer to <a href=\"https://github.com/abraunegg/onedrive/blob/master/docs/business-shared-items.md\"><span style=\" text-decoration: underline; color:#5e81ac;\">Business Shared Folders</span></a> for configuration assistance.</p></body></html>", None))
#endif // QT_CONFIG(tooltip)
...
#if QT_CONFIG(tooltip)
        self.label_ip_protocol_version.setToolTip(QCoreApplication.translate("profile_settings", u"A value of 0 will mean the client will use IPv4 and IPv6. This is the default. A value of 1 will mean the client will use IPv4 only. A value of 2 will mean the client will use IPv6 only.", None))
#endif // QT_CONFIG(tooltip)
...
#if QT_CONFIG(tooltip)
        self.checkBox_download_only.setToolTip(QCoreApplication.translate("profile_settings", u"Replicate the OneDrive online state locally, by only downloading changes from OneDrive. Do not upload local changes to OneDrive.", None))
#endif // QT_CONFIG(tooltip)
...
#if QT_CONFIG(tooltip)
        self.checkBox_upload_only.setToolTip(QCoreApplication.translate("profile_settings", u"Replicate the locally configured sync_dir state to OneDrive, by only uploading local changes to OneDrive. Do not download changes from OneDrive.", None))
#endif // QT_CONFIG(tooltip)
