...
class Ui_profile_settings(object):
    def setupUi(self, profile_settings):
        ...
        self.gridLayout_10.addWidget(self.label_webhook_public_url, 1, 0, 1, 1)
        ...
        self.gridLayout_10.addWidget(self.checkBox_webhook_enabled, 0, 0, 1, 1)
        ...
        self.gridLayout_10.addWidget(self.label_webhook_listening_port, 3, 0, 1, 1)
        ...
        self.gridLayout_10.addWidget(self.label_webhook_expiration_interval, 1, 2, 1, 1)
        ...
        self.gridLayout_10.addWidget(self.lineEdit_webhook_listening_host, 2, 1, 1, 1)
        ...
        self.gridLayout_10.addWidget(self.spinBox_webhook_listening_port, 3, 1, 1, 1)
        ...
        self.gridLayout_10.addWidget(self.label_webhook_listening_host, 2, 0, 1, 1)
        ...
        self.gridLayout_10.addWidget(self.lineEdit_webhook_public_url, 1, 1, 1, 1)
        ...
        self.gridLayout_10.addWidget(self.spinBox_webhook_expiration_interval, 1, 3, 1, 1)
        ...
        self.gridLayout_10.addWidget(self.label_webhook_renewal_interval, 2, 2, 1, 1)
